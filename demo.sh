...
pe "clusterctl generate cluster test1 --from https://raw.githubusercontent.com/capi-samples/choose-your-own-adventure/main/demo/kubeadm-docker.yaml > cluster.yaml"
